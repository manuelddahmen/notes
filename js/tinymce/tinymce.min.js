    ...
    r(l, [], function () {
        ...
        return f.prototype = {
            $$: function (e) {
                ...
                if (v && t.schema) {
                    "abbr article aside audio canvas details figcaption figure footer header hgroup mark menu meter nav output progress section summary time videoFlow".replace(/\w+/g, function (t) {
                        e.createElement(t)
                    });
