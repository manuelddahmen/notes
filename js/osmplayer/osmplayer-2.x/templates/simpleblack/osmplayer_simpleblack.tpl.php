                ...
                <?php if ($params['showController']): ?>
                    <div id="mediaplayer_control">
                        ...
                        <div id="mediaplayer_controlRight">
                            <a id="mediafront_resizeScreen" class="mediaplayerlink mediaplayer_controlspace"
                               href="#fullscreen">
                                <div id="mediafront_resize_to_fullScreen" class="on"><span>make full screen</span></div>
                                <div id="mediafront_resize_to_normalScreen" class="off"><span>make normal screen</span>
                                </div>
                            </a>
