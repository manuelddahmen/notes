...
var drawingApp = (function () {
    ...
    // Creates a canvas element, loads images, adds events, and draws the canvas for the first time.
        init = function () {
            ...
            crayonImage.src = "/images/html5drawing/crayon-outline.png";

            markerImage.onload = resourceLoaded;
            markerImage.src = "/images/html5drawing/marker-outline.png";

            eraserImage.onload = resourceLoaded;
            eraserImage.src = "/images/html5drawing/eraser-outline.png";

            crayonBackgroundImage.onload = resourceLoaded;
            crayonBackgroundImage.src = "/images/html5drawing/crayon-background.png";

            markerBackgroundImage.onload = resourceLoaded;
            markerBackgroundImage.src = "/images/html5drawing/marker-background.png";

            eraserBackgroundImage.onload = resourceLoaded;
            eraserBackgroundImage.src = "/images/html5drawing/eraser-background.png";

            crayonTextureImage.onload = resourceLoaded;
            crayonTextureImage.src = "/images/html5drawing/crayon-texture.png";

            outlineImage.onload = resourceLoaded;
            outlineImage.src = "/images/html5drawing/watermelon-duck-outline.png";
        };
