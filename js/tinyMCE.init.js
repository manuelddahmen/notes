var url1="https://bloknot.manudahmen.be/BlokNot/";
var url2="http://localhost:800/BlokNot/";
...
function BlokNotTInyMCEBrowser(field_name, url, type, win) {
    ...
    var cmsURL = url2+"note/ed_browser";    // script URL - use an absolute path!
