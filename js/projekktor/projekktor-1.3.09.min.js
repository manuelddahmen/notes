...
jQuery(function ($) {
    ...
    $.fn.prop || ($.fn.prop = function (t, e) {
        ...
        if (0 === instances.length) {
            var cfg = arguments[1] || {}, callback = arguments[2] || {}, count = 0, playerA;
        ...
        function PPlayer(srcNode, cfg, onReady) {
            return this.config = new projekktorConfig("1.3.09"), this.env = {
                ...
                var ref = this, itemIdx = null, data = obj || [{}], files = data.playlist || data;
                this.env.loading = !0, this.media = [];
                try {
                    for (var props in data.config)if (data.config.hasOwnProperty(props)) {
                ...
                var e = 0;
                return 1 === this.media.length ? "NA" == this.media[0].mediaModel ? 0 : (this.media[0] = this._prepareMedia({file: ""}), 0) : (void 0 === t || 0 > t || t > this.media.length - 1 ? (this.media.pop(), e = this.media.length) : (this.media.splice(t, 1), e = t), this.env.loading === !1 && this._promote("scheduleModified", this.getItemCount()), e)
            }, this._canPlay = function (t, e, i) {
                var s = this, n = [], a = [], r = i || "http", o = "object" == typeof e ? e : [e], l = t ? t.replace(/x-/, "") : void 0, h = s._testMediaSupport();
                ...
                for (var c in $p.mmap)$p.mmap.hasOwnProperty(c) && (platforms = "object" == typeof $p.mmap[c].platform ? $p.mmap[c].platform : [$p.mmap[c].platform], $.each(platforms, function (i, s) {
                    var n = 0, o = "http";
                    for (var l in t.file)if (t.file.hasOwnProperty(l)) {
                        ...
                        if ($p.mmap[c].level = $.inArray(s, e.config._platforms), $p.mmap[c].level = 0 > $p.mmap[c].level ? 100 : $p.mmap[c].level, h.push("." + $p.mmap[c].ext), a[$p.mmap[c].ext] || (a[$p.mmap[c].ext] = []), a[$p.mmap[c].ext].push($p.mmap[c]), null === $p.mmap[c].streamType || "*" == $p.mmap[c].streamType || $.inArray(o || [], $p.mmap[c].streamType || "") > -1) {
                            ...
                            for (var u = 0, d = r[$p.mmap[c].type].length; d > u; u++)if (r[$p.mmap[c].type][u].model == $p.mmap[c].model) {
                                n = u;
                                break
                            }
                ...
                h = "^.*.(" + h.join("|") + ")$", "string" == typeof t.file && (t.file = [{src: t.file}], "string" == typeof t.type && (t.file = [{
                    src: t.file,
                    type: t.type
                }])), ($.isEmptyObject(t) || t.file === !1 || null === t.file) && (t.file = [{src: null}]);
                for (var d in t.file)if (t.file.hasOwnProperty(d)) {
                    if ("config" == d)continue;
                    if ("string" == typeof t.file[d] && (t.file[d] = {src: t.file[d]}), null == t.file[d].src)continue;
                    ...
                    } else t.file[d].type = this._getTypeFromFileExtension(t.file[d].src);
                ...
                var f = o && o.length > 0 ? o[0] : {type: "none/none", model: "NA", errorCode: 11};
                i = $p.utils.unique(i);
                for (d in t.file)if (t.file.hasOwnProperty(d)) {
                ...
                0 === s.length && s.push({src: null, quality: "default"});
                var g = [];
                ...
                if (this.playerModel.init)switch ("time" != t && "progress" != t && $p.utils.log("Update: '" + t, this.playerModel.getSrc(), this.playerModel.getModelName(), e), t) {
                    ...
                    case"availableQualitiesChange":
                        ...
                        break;
                    case"qualityChange":
                        this.setConfig({playbackQuality: e}), this._promote("qualityChange", e);
                        break;
                    case"volume":
                        this.setConfig({volume: e}), this._promote("volume", e), 0 >= e ? (this.env.muted = !0, this._promote("mute", e)) : this.env.muted === !0 && (this.env.muted = !1, this._promote("unmute", e));
                        break;
                    case"playlist":
                    ...
                    case"time":
                        if (e > this._maxElapsed) {
                            var a = Math.round(100 * e / this.getDuration()), r = !1;
                ...
                var e = this;
                this.env.loading = !0, function () {
                    try {
                        if (e._plugins.length > 0)for (var i = 0; e._plugins.length > i; i++)if (!e._plugins[i].isReady())return setTimeout(arguments.callee, 50), void 0;
                ...
                if (!(this._plugins.length > 0 || 0 === plugins.length))for (var i = 0; plugins.length > i; i++) {
                ...
                if (0 != this._plugins.length) {
                    ...
                    for (var s = 0; e.length > s; s++)for (var n = 0; i > n; n++)if (void 0 != this._plugins[n] && this._plugins[n].name == e[s].toLowerCase()) {
                        this._plugins[n].deconstruct(), this._plugins.splice(n, 1);
                        for (var a in this._pluginCache)for (var r = 0; this._pluginCache[a].length > r; r++)this._pluginCache[a][r].name == e[s].toLowerCase() && this._pluginCache[a].splice(r, 1)
                    }
                }
            }, this.getPlugins = function () {
                var t = [];
                return $.each(this._plugins, function () {
                    t.push({name: this.name, ver: this.version || "unknown"})
                }), t
                ...
                if ("time" != i && "progress" != i && "mousemove" != i && $p.utils.log("Event: [" + i + "]", e, this.listeners), this._pluginCache[i + "Handler"] && this._pluginCache[i + "Handler"].length > 0)for (var n = 0; this._pluginCache[i + "Handler"].length > n; n++)if (this.getConfig("debug"))try {
                    this._pluginCache[i + "Handler"][n][i + "Handler"](e, this)
                } catch (a) {
                    $p.utils.log(a)
                } else this._pluginCache[i + "Handler"][n][i + "Handler"](e, this);
                if (this._pluginCache.eventHandler && this._pluginCache.eventHandler.length > 0)for (var n = 0; this._pluginCache.eventHandler.length > n; n++)if (this.getConfig("debug"))try {
                    this._pluginCache.eventHandler[n].eventHandler(i, e, this)
                } catch (a) {
                    $p.utils.log(a)
                } else this._pluginCache.eventHandler[n].eventHandler(i, e, this);
                if (this.listeners.length > 0)for (var n = 0; this.listeners.length > n; n++)if (this.listeners[n].event == i || "*" == this.listeners[n].event)if (this.getConfig("debug"))try {
                ...
                if (this.env.mouseIsOver && !("|TEXTAREA|INPUT".indexOf("|" + t.target.tagName.toUpperCase()) > -1)) {
                    var e = this, i = this.getConfig("keys").length > 0 ? this.getConfig("keys") : [{
                        27: function (t) {
                ...
                var e = this.getIframeParent() || $(window), i = this.getIframe() || this.getDC(), s = $(e[0].document.body).css("overflow");
                ...
                var e = this.getIframeParent() || $(window), i = this.getIframe() || this.getDC(), s = i.data("fsdata") || null;
                ...
                var t = Array.prototype.slice.call(arguments) || null, e = t.shift(), i = t.shift();
                if (null != e && null != i)for (var s = 0; this._plugins.length > s; s++)if (this._plugins[s].name == e)return this._plugins[s][i](t[0]), void 0
                ...
                var i = e || this._currentItem, s = null != this.config["_" + t] ? this.config["_" + t] : this.config[t];
                ...
                return null == this.env.mediaContainer && (this.env.mediaContainer = $("#" + this.getMediaId())), 0 == this.env.mediaContainer.length && (this.env.mediaContainer = this.env.playerDom.find("." + this.getNS() + "display").length > 0 ? $(document.createElement("div")).attr({id: this.getId() + "_media"}).css({
                    overflow: "hidden",
                    height: "100%",
                    width: "100%",
                    top: 0,
                    ...
                    margin: 0,
                    display: "block"
                }).appendTo(this.env.playerDom.find("." + this.getNS() + "display")) : $(document.createElement("div")).attr({id: this.getMediaId()}).css({
                    width: "1px",
                    height: "1px"
                ...
                for (var s = 0; i.length > s; s++)if (e.indexOf(i[s]) > -1)return t ? i[s].toUpperCase() == t.toUpperCase() : !0;
                return !1
                ...
                var t = this, e = this._testMediaSupport(!0), i = this.getConfig("platforms"), s = [], n = [];
                try {
                    for (var a in this.media[this._currentItem].file)if (this.media[this._currentItem].file.hasOwnProperty(a))for (var r in e)this._canPlay(this.media[this._currentItem].file[a].type.replace(/x-/, ""), e[r].toLowerCase(), this.getConfig("streamType")) && -1 == $.inArray(e[r].toLowerCase(), n) && n.push(e[r].toLowerCase())
                } catch (o) {
                }
                ...
                var t = this, e = {
                    supportsFullScreen: "viewport", isFullScreen: function () {
                        try {
                ...
                return "viewport" == e.supportsFullScreen || "dom" == e.supportsFullScreen && this.getConfig("forceFullViewport") ? e : "mediaonly" == e.supportsFullScreen ? (e.requestFullScreen = function (e) {
                ...
                }, e.dest = {}, e.cancelFullScreen = function () {
                }, e) : (e.isFullScreen = function (e) {
                    ...
                    if (!this.isFullScreen()) {
                        var e = t.getIframeParent() || $(window), i = t.getIframe() ? t.getIframe().get(0) : null || t.getDC().get(0), s = this, n = t.getIframe() ? parent.window.document : document, e = t.getIframeParent() || $(window);
                        e.data("fsdata", {
                            ...
                            if (s.isFullScreen(!0))s.ref.playerModel.applyCommand("fullscreen", !0); else {
                                s.ref.playerModel.applyCommand("fullscreen", !1);
                                var e = s.ref.getIframeParent() || $(window), i = e.data("fsdata");
                                null != i && (e.scrollTop(i.scrollTop), e.scrollLeft(i.scrollLeft))
                            }
                        })
                    }
                }, e.cancelFullScreen = function () {
                    var e = t.getIframe() ? parent.window.document : document, i = t.getIframeParent() || $(window), s = i.data("fsdata");
                ...
                var i = this.env.playerDom.width(), s = this.env.playerDom.height(), n = $p.utils.roundNumber(i / s, 2), a = {};
                return $.each(this.getConfig("playbackQualities") || [], function () {
                ...
                var a = null, r = this, o = !this.getIsMobileClient();
                ...
                return l.xhrFields = {withCredentials: !0}, l.beforeSend = function (t) {
                    t.withCredentials = !0
                }, $.support.cors = !0, $.ajax(l), this
            }, this.setActiveItem = function (t) {
                var e = 0, i = this._currentItem, s = this, n = !1;
                ...
                var e = this.getIframe() || this.getDC(), i = e.data("fsdata") || null, s = t && null != t.width ? t.width : null != this.getConfig("width") ? this.getConfig("width") : !1, n = t && null != t.height ? t.height : null == this.getConfig("height") && this.getConfig("ratio") ? Math.round((s || this.getDC().width()) / this.getConfig("ratio")) : null != this.getConfig("height") ? this.getConfig("height") : !1;
                this.getInFullscreen() && null != i ? (i.targetWidth = s, i.targetHeight = n, e.data("fsdata", i)) : (s && e.css({width: s + "px"}), n && e.css({height: n + "px"}));
                try {
                ...
                return this.listeners.push({event: i[0], ns: i[1], callback: e}), this
            }, this.removeListener = function (t, e) {
                var i = this.listeners.length, s = t.indexOf(".") > -1 ? t.split(".") : [t, "*"];
                ...
                var t = arguments[0] || "", e = arguments[1] || this._getTypeFromFileExtension(t), i = [];
                ...
                return $.inArray(e, this.media[this._currentItem].qualities || []) > -1 && (this.playerModel.applyCommand("quality", e), this.setConfig({playbackQuality: e})), this
                ...
                var i = void 0 !== t.item ? t.item : this.getItemIdx(), s = $.extend(!0, {offset: 0}, e), n = this, a = {
                    ...
                    _timeListener: function (t, e) {
                        if (e.getItemIdx() === this.item || "*" == this.item) {
                            var i = 0 == this.precision ? Math.round(t) : $p.utils.roundNumber(t, this.precision), s = this;
                            if (this._unlocked === !1) {
                ...
                var i = !1, s = this.getCuePoints(e);
                for (var n = 0; s.length > n; n++)if (s.id == t) {
                    i = this;
                    break
                }
                return i
                ...
                null != t && (this._queue.push({command: t, params: e, delay: i}), this._processQueue())
                ...
                var e = "", i = [], s = {}, i = [], n = null, a = !0;
                for (var r in $p.mmap)if ($p.mmap.hasOwnProperty(r)) {
                ...
                if (e.playlist = [], e.playlist[0] = [], e.playlist[0].config = {tracks: []}, t.attr("src") && e.playlist[0].push({
                        src: t.attr("src"),
                        type: t.attr("type") || this._getTypeFromFileExtension(t.attr("src"))
                    }), !$("<video/>").get(0).canPlayType) {
                    var r = t;
                    do if (r = r.next("source,track"), r.attr("src"))switch (r.get(0).tagName.toUpperCase()) {
                        case"SOURCE":
                            e.playlist[0].push({
                                src: r.attr("src"),
                ...
                var i = t || srcNode, s = e || cfg, n = this._readMediaTag(i);
                ...
                var e = this, i = this.getIframeParent();
                ...
                for (var s in this.config._playlist[0])if (this.config._playlist[0][s].type && (this.config._playlist[0][s].type.indexOf("/json") > -1 || this.config._playlist[0][s].type.indexOf("/xml") > -1))return this.setFile(this.config._playlist[0][s].src, this.config._playlist[0][s].type), this;
                ...
                if ("string" == typeof data.css && $("head").append('<style type="text/css">' + $p.utils.parseTemplate(data.css, {rp: data.baseURL}) + "</style>"), "string" == typeof data.html && this.env.playerDom.html($p.utils.parseTemplate(data.html, {p: this.getNS()})), this.env.playerDom.addClass(data.id).addClass(data.variation), this.env.className = this.env.className && 0 !== this.env.className.length ? this.env.className + " " + data.id : data.id, data.variation && 0 !== data.variation.length && (this.env.className += " " + data.variation), "object" == typeof data.config) {
                    ...
                    if ("object" == typeof data.config.plugins)for (var i = 0; data.config.plugins.length > i; i++)try {
        ...
        var i = !1, s = $p.models[e] && void 0 != e ? $p.models[e].prototype : {};
        if ($p.models[t.modelId])return i;
        $p.models[t.modelId] = function () {
        }, $p.models[t.modelId].prototype = $.extend({}, s, t), t.setiLove && t.setiLove(), $p.mmap = $.grep($p.mmap, function (e) {
            var i = e.model != (t.replace ? t.replace.toLowerCase() : ""), s = e.replaces != t.modelId;
            return i && s
        });
...
projekktorConfig.prototype = {
    ...
    $p.utils = {
        imageDummy: function () {
            ...
            var e = "abcdefghiklmnopqrstuvwxyz", i = "";
            for (var s = 0; t > s; s++) {
            ...
            var e = location, i, s, n, a;
            if (null == t || "" == t)return "";
            if (/^\w+:/.test(t))return t;
            if (i = e.protocol + "//" + e.host, 0 === t.indexOf("/"))return i + t;
            if (s = e.pathname.replace(/\/[^\/]*$/, ""), n = t.match(/\.\.\//g))for (t = t.substring(3 * n.length), a = n.length; a--;)s = s.substring(0, s.lastIndexOf("/"));
            return i + s + "/" + t
        }, strip: function (t) {
            ...
            var i = Math.floor(t / 3600), s = t % 3600, n = Math.floor(s / 60), a = s % 60, r = Math.floor(a);
            return 10 > i && (i = "0" + i), 10 > n && (n = "0" + n), 10 > r && (r = "0" + r), e === !0 ? i + ":" + n : i + ":" + n + ":" + r
        }, embeddFlash: function (e, i, s, n) {
            var a = i.FlashVars || {}, r = "", o = "", l = "", h = "", u = e, c = "";
            ...
            var t = 3, e = document.createElement("div"), i = e.getElementsByTagName("i");
            ...
            if (null == i)return !1;
            i instanceof t == !1 && (i = t(i)), i.data("od") || i.data("od", {width: i.width(), height: i.height()});
            var o = void 0 !== a ? a : i.data("od").width, l = void 0 !== r ? r : i.data("od").height, h = s / o, u = n / l, c = s, d = n;
            switch (e) {
                case"none":
                    c = o, d = l;
                    break;
            ...
            }, i = e.parser[e.strictMode ? "strict" : "loose"].exec(t), s = {}, n = 14;
            ...
            var t = document.createElement("z"), e = t.style;

            function i(t) {
                for (var i in t)if (null != e[t[i]])return !0;
                return !1
            }

            function s(t) {
                var e = "Webkit Moz O ms Khtml".split(" "), s = t.charAt(0).toUpperCase() + t.substr(1), n = (t + " " + e.join(s + " ") + s).split(" ");
                return i(n)
            }

            return s("animationName")
        }, versionCompare: function (t, e) {
            var i = t.split("."), s = e.split("."), n = 0;
            ...
            var i, s, n = [], a = t && t.constructor == Array;
    ...
    $p.platforms = {
        VLC: function () {
            if (navigator.plugins && navigator.plugins.length > 0) {
                for (var t = 0; navigator.plugins.length > t; ++t)if (-1 != navigator.plugins[t].name.indexOf("VLC")) {
            ...
            var e = navigator.userAgent.toLowerCase(), i = e.indexOf("os ");
...
jQuery(function ($) {
    projekktorPluginInterface.prototype = {
        ...
        sendEvent: function (t, e) {
            this.pp._promote({_plugin: this.name, _event: t}, e)
        },
        ...
        cookie: function (key, value, ttl) {
            ...
            var t = new Date, result = null, cookieString = "", tmp = storedData = jQuery.parseJSON(eval(result = RegExp("(?:^|; )" + encodeURIComponent(this.getConfig("cookieName") + "_" + this.name) + "=([^;]*)").exec(document.cookie)) ? decodeURIComponent(result[1]) : null);
...
jQuery(function (t) {
    playerModel.prototype = {
        ...
        getPoster: function () {
            var t = "poster", e = null, i = this.pp.getConfig(t), s = "default", n = [];
        ...
        getMediaDimensions: function () {
            return {width: this.media.videoWidth || 0, height: this.media.videoHeight || 0}
        },
        getSource: function () {
            var e = [], i = this.media.offset || this.media.position || !1, s = this, n = "pseudo" == this.pp.getConfig("streamType") ? this.pp.getConfig("startParameter") : !1;
            return t.each(this.media.file || [], function () {
                if (s._quality != this.quality && null !== s._quality)return !0;
                if (!n || !i)return e.push(this), !0;
                var a = $p.utils.parseUri(this.src), r = a.protocol + "://" + a.host + a.path, o = [];
        ...
        timeListener: function (t) {
            if (null != t) {
                var e = parseFloat((t.position || t.currentTime || this.media.position || 0).toFixed(2)), i = parseFloat((t.duration || 0).toFixed(2));
        ...
        loadProgressUpdate: function () {
            var t = this.mediaElement.get(0), e = 0;
        ...
        setTestcard: function (e, i) {
            var s = this.pp.getMediaContainer().html("").css({
                width: "100%",
                height: "100%"
            }), n = t.extend(this.pp.getConfig("messages"), this.pp.getConfig("msg")), a = null == n[e] ? 0 : e, r = void 0 !== i && "" !== i ? i : n[a];
            this.removeListeners(), this.detachMedia(), this.pp.getItemCount() > 1 && (r += " " + n[99]), 3 > r.length && (r = "ERROR"), 100 == a && (r = i), r = $p.utils.parseTemplate(r, t.extend({}, this.media, {title: this.pp.getConfig("title")})), this.mediaElement = t("<div/>").addClass(this.pp.getNS() + "testcard").attr("id", this.pp.getId() + "_testcard_media").html("<p>" + r + "</p>").appendTo(s), null != this.pp.getConfig("msg")[a] && this.mediaElement.addClass(this.pp.getNS() + "customtestcard")
        },
        applySrc: function () {
        },
        applyImage: function (e, i) {
            var s = t("<img/>").hide(), n = this;
            if ($p.utils.blockSelection(s), null == e || e === !1)return t("<span/>").attr({id: this.pp.getMediaId() + "_image"}).appendTo(i);
            s.html("").appendTo(i).attr({
                id: this.pp.getMediaId() + "_image",
                alt: this.pp.getConfig("title") || ""
            }).css({position: "absolute"}), s.error(function (e) {
                t(this).remove()
            }), s.load(function (t) {
            ...
            var a = function (t, e) {
                ...
                var i = e.width(), s = e.height(), a = t.width(), r = t.height();
        ...
        _waitforPlayer: function () {
            ...
            this._displayReady !== !0 && (this._setBufferState("empty"), function () {
                if (i > 6 && e._isFF()) {
                    i = 0;
                    var s = t(e.mediaElement).parent(), n = t(e.mediaElement).clone();
        ...
        _scaleVideo: function (t) {
            ...
            if (!this.pp.getIsMobileClient())try {
                var i = e.width(), s = e.height(), n = this.media.videoWidth, a = this.media.videoHeight;
    ...
    $p.newModel({
        ...
        applySrc: function () {
            var e = this, i = this.getSource(), s = e.getState("AWAKENING");
        ...
        addListeners: function (e, i) {
            if (null != this.mediaElement) {
                var s = null != i ? ".projekktor" + i + this.pp.getId() : ".projekktor" + this.pp.getId(), n = this, a = null == e ? "*" : e;
        ...
        removeListener: function (e, i) {
            if (null != this.mediaElement) {
                var s = null != i ? ".projekktor" + i + this.pp.getId() : ".projekktor" + this.pp.getId(), n = this;
        ...
        _ended: function () {
            var t = this.mediaElement[0].duration, e = Math.round(this.media.position) === Math.round(t), i = 2 > t - this.media.maxpos && 0 === this.media.position || !1;
        ...
        setSeek: function (t) {
            ...
            return this.isPseudoStream ? (this.media.position = 0, this.media.offset = t, this.applySrc(), void 0) : (function () {
                try {
                    e.mediaElement[0].currentTime = t, e.timeListener({position: t})
                } catch (i) {
        ...
        modelId: "AUDIO",
        iLove: [{ext: "ogg", type: "audio/ogg", platform: "native", streamType: ["http", "httpAudio"]}, {
            ext: "oga",
            type: "audio/ogg",
            platform: "native",
        ...
        imageElement: {},
        applyMedia: function (e) {
            $p.utils.blockSelection(e), this.imageElement = this.applyImage(this.getPoster("cover") || this.getPoster("poster"), e), this.imageElement.css({border: "0px"}), 0 === t("#" + this.pp.getMediaId() + "_html").length && (this.wasPersistent = !1, e.html("").append(t(this.isGingerbread ? "<video/>" : "<audio/>").attr({
                id: this.pp.getMediaId() + "_html",
                poster: $p.utils.imageDummy(),
                loop: !1,
                autoplay: !1,
        ...
        setPosterLive: function () {
            if (this.imageElement.parent) {
                var e = this.imageElement.parent(), i = this;
    ...
    $p.newModel({
        ...
        setiLove: function () {
            var e = this;
            if (navigator.plugins && navigator.plugins.length > 0)for (var i = 0; navigator.plugins.length > i; ++i)if (navigator.plugins[i].name.indexOf("VLC") > -1) {
    ...
    $p.newModel({
        ...
        iLove: [{ext: "flv", type: "video/flv", platform: "flash", fixed: !0, streamType: ["*"]}, {
            ext: "mp4",
            type: "video/mp4",
            platform: "flash",
            streamType: ["*"]
            ...
            platform: "flash",
            streamType: ["*"]
        }, {ext: "m4v", type: "video/mp4", platform: "flash", fixed: !0, streamType: ["*"]}, {
            ext: "f4m",
            type: "application/f4m+xml",
            platform: "flash",
            fixed: !0,
            streamType: ["*"]
        }, {ext: "m3u8", type: "application/mpegURL", platform: "flash", fixed: !0, streamType: ["*"]}, {
            ext: "m3u8",
            type: "application/x-mpegURL",
            platform: "flash",
            fixed: !0,
            ...
            fixed: !0,
            streamType: ["*"]
        }, {ext: "manifest", type: "application/vnd.ms-ss", platform: "flash", fixed: !0, streamType: ["*"]}],
        hasGUI: !1,
        allowRandomSeek: !1,
        isPseudoStream: !1,
        streamType: "http",
        ...
        _OSMFListener: function () {
            var e = arguments[0][1], i = arguments[0][2], s = this;
        ...
        OSMF_durationChange: function (t) {
            isNaN(t) || (this.timeListener({position: this.media.position, duration: t || 0}), this.seekedListener())
        },
        ...
        OSMF_updateDynamicStream: function () {
            var e = this.mediaElement.get(0).getStreamItems(), i = "", s = [];
        ...
        modelId: "OSMFVIDEONA",
        iLove: [{ext: "flv", type: "video/flv", platform: "flashna", fixed: !0, streamType: ["*"]}, {
            ext: "mp4",
            type: "video/mp4",
            platform: "flashna",
            streamType: ["*"]
            ...
            platform: "flashna",
            streamType: ["*"]
        }, {ext: "m4v", type: "video/mp4", platform: "flashna", fixed: !0, streamType: ["*"]}, {
            ext: "f4m",
            type: "application/f4m+xml",
            platform: "flashna",
            fixed: !0,
        ...
        replace: "AUDIOFLASH",
        hasGUI: !1,
        iLove: [{ext: "mp3", type: "audio/mp3", platform: "flash", streamType: ["*"]}, {
            ext: "m4a",
            type: "audio/mp4",
            platform: "flash",
            streamType: ["*"]
        ...
        applyMedia: function (e) {
            ...
            var n = {
                ...
                seamlesstabbing: "false",
                bgcolor: "#ccc",
                FlashVars: t.extend({javascriptCallbackFunction: "window.projekktorOSMFReady" + this.pp.getId()}, this.pp.getConfig("OSMFVars"))
            };
    ...
    $p.newModel({
        ...
        applyMedia: function (e) {
            this._setBufferState("empty");
            var i = this, s = "YTAUDIO" == this.modelId ? 1 : "100%", n = "YTAUDIO" == this.modelId ? 1 : "100%";
        ...
        onReady: function () {
            ...
            t.ajax({
                ...
                complete: function (i, s) {
                    try {
                        data = i.responseText, "string" == typeof data && (data = t.parseJSON(data)), data.data.title && e.sendUpdate("config", {title: data.data.title + " (" + data.data.uploader + ")"})
                    } catch (n) {
                    }
                    e.displayReady()
                }
        ...
        mousedownHandler: function (e) {
            ...
            if (-1 != (t(e.target).attr("id") || "").indexOf("_media") && (clearTimeout(this._cursorTimer), this.display.css("cursor", "auto"), 1 == e.which)) {
                switch (this.pp.getState()) {
                    case"ERROR":
                        return this.pp.setConfig({disallowSkip: !1}), this.pp.setActiveItem("next"), void 0;
                    case"IDLE":
        ...
        showBufferIcon: function (t) {
            ...
            if (clearTimeout(this.bufferDelayTimer), !this.pp.getHasGUI()) {
                ...
                if (!this.buffIcn.hasClass("active") && (this.buffIcn.addClass("active").removeClass("inactive"), null !== e.buffIcnSprite)) {
                    var i = e.config.spriteCountUp === !0 ? 0 : (e.config.spriteHeight + e.config.spriteOffset) * (e.config.spriteTiles - 1), s = i;
                    e.buffIcnSprite.addClass("active").removeClass("inactive"), function () {
...
jQuery(function (t) {
    projekktorControlbar.prototype = {
        ...
        controlElementsConfig: {
            ...
            loaded: null,
            golive: [{on: ["touchstart", "click"], call: "goliveClk"}, {on: ["touchend"], call: "touchEnd"}],
            scrubber: null,
            scrubbertip: null,
            scrubberknob: null,
            ...
            }, {on: ["mousemove"], call: "scrubberdragTooltip"}, {
                on: ["mousedown"],
            ...
            mute: [{on: ["touchstart", "click"], call: "muteClk"}, {
                on: ["mouseout"],
                call: "volumeBtnOut"
            }, {on: ["mousemove"], call: "volumeBtnHover"}, {on: ["touchend"], call: "touchEnd"}],
        ...
        initialize: function () {
            var e = this, i = this.playerDom.html(), s = !0, n = this.pp.getNS();
            for (var a in this.controlElementsConfig)if (i.match(RegExp(n + a, "gi"))) {
                s = !1;
                break
            }
        ...
        addGuiListeners: function () {
            ...
            t.each(this.controlElementsConfig, function (i, s) {
                ...
                for (var n = 0; s.length > n; n++)null != s[n].on && t.each(s[n].on, function (t, a) {
                    var r = "on" + a in window.document, o = s[n].call;
                    if (!r) {
        ...
        displayTime: function (e, i, s) {
            if (!this.pp.getHasGUI()) {
                var n = Math.round(10 * (e || this.pp.getLoadPlaybackProgress() || 0)) / 10, a = i || this.pp.getDuration() || 0, r = s || this.pp.getPosition() || 0, o = t.extend({}, this._clockDigits(a, "dur"), this._clockDigits(r, "elp"), this._clockDigits(a - r, "rem"));
                if (this.controlElements.playhead.data("pct") != n) {
                    this.controlElements.playhead.data("pct", n).css({width: n + "%"}), this.controlElements.scrubberknob.css({left: n + "%"});
        ...
        displayVolume: function (e) {
            ...
            if (1 != this._vSliderAct && null != e) {
                var s = this.cb.hasClass("active"), i = this, n = this.getConfig("fixedVolume"), a = this.controlElements.mute.hasClass("toggle") || this.controlElements.unmute.hasClass("toggle") || this.getConfig("toggleMute");
                if (this._active("mute", !n), this._active("unmute", !n), this._active("vmax", !n), this._active("vknob", !n), this._active("vmarker", !n), this._active("vslider", !n), !n) {
                    ...
                    var r = this.controlElements.volume.find("li"), o = r.length - Math.ceil(100 * e / r.length);
        ...
        displayCuePoints: function (e) {
            var i = this, s = this.pp.getNS();
            this.getConfig("showCuePoints") && (i.controlElements.scrubber.remove("." + s + "cuepoint"), t.each(this.pp.getCuePoints() || [], function () {
                var n = Math.max(100 / e, Math.round(e / 100), 1), a = 100 * this.on / e - 100 * (n / 2) / e, r = this, o = i.pp, l = t(document.createElement("div")).addClass(s + "cuepoint").addClass("inactive").css("left", a + "%").css("width", n + "%").data("on", this.on);
        ...
        displayQualityToggle: function (e) {
            var i = this.getConfig("playbackQualities"), s = this.pp.getPlaybackQualities(), n = this.pp.getNS();
            ...
            for (var a = i.length; a--; a > 0)if (t.inArray(i[a].key, s) > -1 && best.push(i[a].key), best.length > 1)break;
        ...
        vsliderClk: function (e) {
            if (1 != this._vSliderAct) {
                var i = t(this.controlElements.vslider), s = i.width() > i.height() ? "hor" : "vert", n = "hor" == s ? i.width() : i.height(), a = e.originalEvent.touches ? e.originalEvent.touches[0].pageX : e.pageX, r = e.originalEvent.touches ? e.originalEvent.touches[0].pageY : e.pageY, o = "hor" == s ? a - i.offset().left : r - i.offset().top, l = 0;
        ...
        scrubberdragTooltip: function (e) {
            if (0 != this.pp.getDuration()) {
                ...
                var i = t(this.controlElements.scrubberdrag[0]), s = t(this.controlElements.loaded[0]), n = t(this.controlElements.scrubbertip), a = e.originalEvent.touches ? e.originalEvent.touches[0].pageX : e.pageX, r = e.originalEvent.touches ? e.originalEvent.touches[0].pageY : e.pageY, o = a - i.offset().left - n.outerWidth() / 2, l = this.pp.getDuration() / 100 * (100 * (a - i.offset().left) / i.width()), h = this._clockDigits(l, "tip");
                if (this._isDVR) {
                    l = this.pp.getDuration() - l;
                    var u = new Date(1e3 * ((new Date).getTime() / 1e3 - l)), u = u.getSeconds() + 60 * u.getMinutes() + 3600 * u.getHours();
                ...
                o = 0 > o ? 0 : o, o = o > i.width() - n.outerWidth() ? i.width() - n.outerWidth() : o, n.css({left: o + "px"})
            }
        },
        scrubberdragStartDragListener: function (e) {
            if (1 != this.getConfig("disallowSkip")) {
                this._sSliderAct = !0;
                var i = this, s = t(this.controlElements.scrubberdrag[0]), n = t(this.controlElements.loaded[0]), a = 0, r = Math.abs(parseInt(s.offset().left) - e.clientX), o = function (t) {
        ...
        vknobStartDragListener: function (e, i) {
            this._vSliderAct = !0;
            var s = this, n = this.pp.getInFullscreen() === !0 && this.controlElements.vslider.length > 1 ? 1 : 0, a = t(i[n]), r = t(this.controlElements.vslider[n]), o = Math.abs(parseFloat(a.position().left) - e.clientX), l = Math.abs(parseFloat(a.position().top) - e.clientY), h = 0, u = function (t) {
                ...
                var i = e.clientX - o, i = i > r.width() - a.width() / 2 ? r.width() - a.width() / 2 : i, i = 0 > i ? 0 : i, u = e.clientY - l, u = u > r.height() - a.height() / 2 ? r.height() - a.height() / 2 : u, u = 0 > u ? 0 : u;
        ...
        handleStartDragListener: function (t, e) {
            var i = this, s = Math.abs(parseInt(this.cb.position().left) - t.clientX), n = Math.abs(parseInt(this.cb.position().top) - t.clientY);
            var a = function (t) {
        ...
        _getVolume: function () {
            var t = parseFloat(this.cookie("volume") || this.getConfig("volume") || .5), e = this.cookie("muted") || !1;
        ...
        _clockDigits: function (t, e) {
            ...
            var i = Math.floor(t / 3600), s = t % 3600, n = Math.floor(s / 60), a = 60 * i + n, r = s % 60, o = Math.floor(r), l = t, h = {};
...
jQuery(function (t) {
    projekktorContextmenu.prototype = {
        ...
        _items: {},
        initialize: function () {
            var e = this, i = this.pp.getIframeWindow() || t(window);
        ...
        mousedownHandler: function (e) {
            switch (e.which) {
                case 3:
                    var i = this.pp.getDC().offset(), s = e.pageY - i.top, n = e.pageX - i.left;
